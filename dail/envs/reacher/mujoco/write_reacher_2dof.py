...
class WRITE_Reacher2DOFEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    def __init__(self):
        self.offset = 0  ## Offset is 180 degrees
        self.target_pos = [
            [0.1, 0.2],
            [0.2, 0.1],
            [0.1, 0],
    ...
    def _step(self, a):
        ...
        vec = self.get_body_com("fingertip")[:2] - np.array(
            self.target_pos[self.cur_target_idx]
        )
