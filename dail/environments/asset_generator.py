...
from dail.environments import snake_generator, reacher_generator, centipede_generator
...
OUTPUT_BASE_DIR = os.path.join(os.path.dirname(os.path.realpath(__file__)), "assets")
