...
from dail.environments import asset_generator
...
for env in asset_generator.TASK_DICT:
    ...
    for i_part in np.sort(asset_generator.TASK_DICT[env]):
        ...
        # transfer learning)
        registered_name = (
            env + num2words.num2words(i_part)[0].upper() + num2words.num2words(i_part)[1:]
        )
...
def get_mujoco_model_settings():
    ...
    OB_MAP = {
        "Humanoid-v1": ["qpos", "qvel", "cinert", "cvel", "qfrc_act", "cfrc"],
